...
pxcert2
pxcert3
 using c:\atuscps_2019.dat, stringcols(1) ;
...
label variable peern "Edited: total weekly earnings from overtime pay, tips, and commissions (2 implied decimals)";
...
label variable pxcert1 "PECERT1: allocation flag";
label variable pxcert2 "PECERT2: allocation flag";
label variable pxcert3 "PECERT3: allocation flag";
...
23 "2012-2013"
24 "2014-2015"
25 "2016-2018 or 2016-2019 (see note)"
;
...
*/
label values pemomtyp   labelpemomtyp;
/*
...
label values pxdisdrs labelpxdisdrs;
label values pxdisear labelpxdisear;
label values pxdiseye labelpxdiseye;
label values pxdisout labelpxdisout;
label values pxdisphy labelpxdisphy;
label values pxdisrem labelpxdisrem;
...
label values pxpdemp1   labelpxpdemp1;
label values pxnmemp1   labelpxnmemp1;
