...
*;
data atusresp_2016;
infile "c:\atusresp_2016.dat" firstobs=2 dsd missover lrecl=16384 dlm=",";
length
 TUCASEID $14
 TULINENO 8
 TUYEAR 8 
...
label TEERN = "Edited: total weekly overtime earnings (2 implied decimals)";
...
label TREMODR = "Eating and Health Module respondent";
...
;
value TREMODR /* TREMODR */
-1 = "Blank"
-2 = "Don't Know"
-3 = "Refused"
0 = "Did not respond to Eating and Health Module"
1 = "Responded to the Eating and Health Module"
;
...
;
proc contents data=atusresp_2016; run;
